...
Distribution of r.squared is normal, and distribution log(beta1\*beta2) is left skewed.We have a total of `r num_na` NA for log(beta1\*beta2) in our data.
